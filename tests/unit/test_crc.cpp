...
TEST_CASE(CRC32, SingleCharacter) {
    ...
    ASSERT_EQ(result_a, 0xE8B7BE43);

    const char* z = "Z";
    unsigned int result_z = crc32_buf(z, 1);
    ASSERT_EQ(result_z, 0x59BC5767);
}
